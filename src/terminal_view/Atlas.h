...
struct RenderTexture {
    ...
    constexpr bool operator<(RenderTexture const& _rhs) const noexcept
    {
        // TODO: total ordering damit die rendering calls minimiert und optimisert werden
        // koennen - sort(vectorOfInstrs) sollte funktionieren
        return atlas < _rhs.atlas;
    }
};
